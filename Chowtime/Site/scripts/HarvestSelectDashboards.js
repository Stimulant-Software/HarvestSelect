        ...
        $.ajax('../api/WeighBack/WeighBackList', {
            ...
            success: function (msg) {
                ...
                $.when($('.form-container').empty().append(formHtml)).then(function () {
                    ...
                    $('#redfillet' + $WeightBackID).blur(function () {
                        var newValue = $(this).val();
                        $('#redfilletpct' + $WeightBackID).val((newValue / .36).toFixed(2));
                    });
                    $('#dresseddisease' + $WeightBackID).blur(function () {
                        var newValue = $(this).val();
