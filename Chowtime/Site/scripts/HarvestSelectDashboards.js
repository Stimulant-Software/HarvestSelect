            ...
            success: function (msg) {
                ...
                $.when($('.form-container').empty().append(formHtml)).then(function () {
                    ...
                    $('.redfillet').each(function () {
                        var $current = $(this);
                        if ($current.val() != "") {
                            $WeightBackID = $current.attr('id').slice(- 1);
                            $('#redfilletpct' + $WeightBackID).val(($current.val() / .36).toFixed(2));
                        }
                    });
                    $('.dresseddisease').each(function () {
                        ...
                        if ($current.val() != "") {
                            $WeightBackID = $current.attr('id').slice(- 1);
                            $('#dresseddiseasepct' + $WeightBackID).val(($current.val() / .36).toFixed(2));
                        }
                    });
                    $('.redfillet').blur(function () {
                        var newValue = $(this).val();
                        var correctID = $(this).attr('id').replace('redfillet', '');
                        $('#redfilletpct' + correctID).val((newValue / .36).toFixed(2));
                    });
                    $('.dresseddisease').blur(function () {
                        var newValue = $(this).val();
                        var correctID = $(this).attr('id').replace('dresseddisease', '');
                        $('#dresseddiseasepct' + correctID).val((newValue / .6).toFixed(2));
                    });
                });
